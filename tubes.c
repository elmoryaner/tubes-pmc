...
int i,j,temp;
int NumberOfVariable,NumberOfAllMinterm;
int NumberOfEPI=0,NumberOfRemainingMT,NumberOfRemainingPI;
int NumberOfPI=0,PotEPINo=0,NumberOfPossibleEPI=1,MinimumNo=0,Groupable=1;

int *MintermIndicesDecimal, **Minterm_Binary,****Column, **PI_Index,**EPI_Index,*NumberCounter;
...
int main()
{
    ...
    /* ReducedPIChart[i][j] merupakan isi dari Reduced PI Chart
